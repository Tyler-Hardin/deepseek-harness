...
| [voice.md](voice.md) | speech-to-text for the Web composer: the `transcribe` Remote, cloud/local routing, credential resolution, and the `/voice-local` backend command |
