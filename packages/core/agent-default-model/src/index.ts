 ...
 * The shared `agent-default-model` section holds the deployment-wide
...
export const WORKSPACE_DEFAULT_MODEL_SETTINGS_NAMESPACE = 'workspace-default-model'
 ...
 * is mounted, its user layer is read live. A workspace id keyed second layer
 * carries explicit per-workspace overrides.
 */
export class AgentDefaultModelConfig extends Service {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    ctx.inject(['settings'], (settingsCtx) => {
      ...
      settingsCtx.settings.installSection(ctx, WORKSPACE_DEFAULT_MODEL_SETTINGS_NAMESPACE, WORKSPACE_DEFAULT_MODEL_SETTINGS_SCHEMA, {}, {
