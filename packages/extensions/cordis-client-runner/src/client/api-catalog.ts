    ...
    methods: [
      {
        ...
        description: 'Register an existing path, local or remote, as a Workspace.',
        parameters: [{ name: 'input', description: 'Host create payload: the working path plus the place to adopt.' }],
