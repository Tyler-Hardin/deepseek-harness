...
| [`ui-app-settings/`](ui-app-settings/README.md) | Provides the App settings page (hostname, certificate, diagnostics) inside the native dsh app, via the `window.DshApp` bridge. |
