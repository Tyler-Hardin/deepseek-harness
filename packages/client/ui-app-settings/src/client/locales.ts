...
export const en = {
  ...
  save: 'Save',
  monitorLabel: 'Background notifications',
  monitorToggle: 'Notify me when a task finishes',
  monitorHint: 'Rings when a session run finishes, errors, or waits for your input while the app is not on screen. While on, a persistent "dsh is monitoring" notification stays in the shade so the monitor is never silently dead.',
...
export const zh: Record<keyof typeof en, string> = {
  ...
  save: '保存',
  monitorLabel: '后台任务通知',
  monitorToggle: '任务完成时通知我',
  monitorHint: '应用不在屏幕前时，会话运行结束、出错或停下来等待你输入时响铃。开启期间，通知栏会保留一条常驻的"dsh 正在监控"通知，监控器永远不会无声死亡。',
