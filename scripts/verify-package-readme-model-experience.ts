...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/bash-ssh': { kind: 'indirect', reason: 'The executor backend delegates model rendering to dsh-tool-bash.' },
  'packages/worlds/worlds': { kind: 'indirect', reason: 'The worlds service exposes per-world backends to router providers; consumers render any model-facing effect.' },
  'packages/worlds/worlds-local': { kind: 'indirect', reason: 'The local worlds provider composes fs-local/bash-local backends; their consumers render any model-facing effect.' },
  'packages/shell/shell-router': { kind: 'indirect', reason: 'The router delegates to per-world executors whose consumers render any model-facing effect.' },
  ...
  'packages/client/ui-app-settings': { kind: 'none', reason: 'Browser-side App settings page; registers nothing model-facing and changes no prompts, tool schemas, requests, or session events.' },
  ...
  'packages/ssh/ssh': { kind: 'indirect', reason: 'The transport seam delegates model rendering to the fs-ssh/bash-ssh adapters and their consumers.' },
  'packages/ssh/ssh-client': { kind: 'indirect', reason: 'The ssh2 backend delegates model rendering to the fs-ssh/bash-ssh adapters and their consumers.' },
  'packages/ssh/ssh-worlds': { kind: 'indirect', reason: 'The ssh worlds provider composes fs-ssh/bash-ssh backends; their consumers render any model-facing effect.' },
  ...
  'packages/client/ui-sandbox-settings': { kind: 'indirect', reason: 'The settings row stores the sandbox.extraWritableRoots list; the sandbox policy consumer owns the model-visible roots sentence.' },
  ...
  'packages/terminal/terminal-ssh': { kind: 'indirect', reason: 'The remote shell backend delegates model rendering to dsh-tool-terminal.' },
  ...
  'packages/fs/fs-ssh': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-fs.' },
  'packages/fs/fs-router': { kind: 'indirect', reason: 'The router delegates to per-world backends whose consumers render any model-facing effect.' },
  ...
  'packages/voice/voice-context': { kind: 'none', reason: 'Human speech transcription; its text reaches a model request only when the user submits the resulting composer draft.' },
