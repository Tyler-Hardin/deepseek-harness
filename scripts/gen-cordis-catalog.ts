...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TranscribeRequest: 'voice.md',
  TranscribeResult: 'voice.md',
  ...
  WorkspaceDefaultModelValue: 'workspace.md',
  SshConnectOptions: 'ssh.md',
  SshTarget: 'ssh.md',
  SshWorld: 'ssh.md',
  SshWorldId: 'ssh.md',
  ResolvedSshHost: 'ssh.md',
  SshErrorCode: 'ssh.md',
  SshPtyHandle: 'ssh.md',
  SshPtyOptions: 'ssh.md',
  ...
  WorldId: 'worlds.md',
  WorldKind: 'worlds.md',
  WorldStatus: 'worlds.md',
  WorldsResolveRequest: 'worlds.md',
  WorkspacePlace: 'workspace.md',
